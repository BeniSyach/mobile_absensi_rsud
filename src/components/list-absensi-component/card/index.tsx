  ...
  <View className="mb-4 flex-row items-start">
    ...
    <View className="flex-1">
      <View className="flex-row items-center">
        <Text className="w-32 text-sm font-bold text-gray-700">
          Absen Masuk
        </Text>
      ...
      <View className="flex-row items-center">
        <Text className="w-32 text-sm font-bold text-gray-700">Keterangan</Text>
        <Text className="flex-1 text-sm text-gray-600">
          : {keterangan || '-'}
        </Text>
      </View>
      <View className="flex-row items-center">
        <Text className="w-32 text-sm font-bold text-gray-700">Status</Text>
        <Text className="flex-1 text-sm text-gray-600">: {tpp_in || '-'}</Text>
      </View>
    </View>
  </View>
);
