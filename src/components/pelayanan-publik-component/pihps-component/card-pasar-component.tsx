...
export default function CardPasar({ data }: dataresPasar) {
  return (
    <View
      style={{ width: CARD_WIDTH - 15, marginBottom: 16, marginRight: 16 }}
      className="min-h-[110px] justify-between rounded-xl bg-white p-4 shadow"
    >
      <Text className="text-center font-bold">{data.nama_komoditi}</Text>
