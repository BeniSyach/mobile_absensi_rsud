...
import {
  FormPangkatGolongan,
  type PangkatGolonganFormProps,
} from './form-pangkat-golongan';

export default function AddPangkatGolongan() {
  const router = useRouter();
  const { mutate, isPending, isError } = PostSPT();
  const onSubmit: PangkatGolonganFormProps['onSubmit'] = (data) => {
