...
import {
  type DiklatFungsionalFormProps,
  FormDiklatFungsional,
} from './form-diklat-fungsional';

export default function AddDiklatFungsional() {
  const router = useRouter();
  const { mutate, isPending, isError } = PostSPT();
  const onSubmit: DiklatFungsionalFormProps['onSubmit'] = (data) => {
