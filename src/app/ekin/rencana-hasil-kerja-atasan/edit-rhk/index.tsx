...
import FormEditRHKAtasan from '@/components/ekin-component/rencana-hasil-kerja-atasan-compoenet/edit/form-edit-rhk-atasan';
  ...
  return (
    <SafeAreaView className="flex-1 bg-[#287BDC]">
      ...
      >
        ...
        <FormEditRHKAtasan data={dataProfile} dataEdit={item} />
      </ImageBackground>
    </SafeAreaView>
  );
}
