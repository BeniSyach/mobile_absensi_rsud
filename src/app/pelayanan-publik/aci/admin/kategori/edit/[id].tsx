...
import { useEditKategoriLogic } from './use-edit-kategori-logic';
...
const Header = ({ router }: { router: ReturnType<typeof useRouter> }) => (
  <View className="bg-white px-6 pb-4 pt-12 shadow-sm shadow-gray-100">
    <View className="flex-row items-center">
      ...
      <Text className="text-xl font-bold text-[#0B2347]">Edit Kategori</Text>
    </View>
  </View>
);
...
const SubmitButton = ({
  ...
  <TouchableOpacity
    className={`flex-row items-center justify-center rounded-xl py-4 shadow-lg shadow-blue-200 ${
      submitting ? 'bg-blue-400' : 'bg-[#0066FF]'
    }`}
    onPress={onPress}
    disabled={submitting}
  >
